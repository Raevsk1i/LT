# 1 "c:\\users\\raevs\\onedrive\\\344\356\352\363\354\345\355\362\373\\vugen\\scripts\\uc_01_add_new_member\\\\combined_UC_01_add_new_member.c"
...
# 1 "c:\\users\\raevs\\onedrive\\\344\356\352\363\354\345\355\362\373\\vugen\\scripts\\uc_01_add_new_member\\\\combined_UC_01_add_new_member.c" 2
...
# 2 "c:\\users\\raevs\\onedrive\\\344\356\352\363\354\345\355\362\373\\vugen\\scripts\\uc_01_add_new_member\\\\combined_UC_01_add_new_member.c" 2
...
# 3 "c:\\users\\raevs\\onedrive\\\344\356\352\363\354\345\355\362\373\\vugen\\scripts\\uc_01_add_new_member\\\\combined_UC_01_add_new_member.c" 2
...
# 4 "c:\\users\\raevs\\onedrive\\\344\356\352\363\354\345\355\362\373\\vugen\\scripts\\uc_01_add_new_member\\\\combined_UC_01_add_new_member.c" 2

# 1 "Action.c" 1
Action()
{
	lr_param_sprintf("user", "%s%s%s%s%s",
	...
	lr_param_sprintf("userId", "%s%s%s%s",
	                 lr_eval_string("{p_RandomNumber}"),
	                 lr_eval_string("{p_RandomNumber}"),
	                 lr_eval_string("{p_RandomNumber}"),
	                 lr_eval_string("{p_RandomNumber}"));
	...
	lr_end_transaction("UC_01_TR_02_go_to_group",2);
	...
	web_custom_request("teamMember_2", 
		...
		"Body=[{\"email\":\"{user}{userId}@mail.ru\",\"permissionList\":[\"ADMIN\",\"VIEW\",\"EDIT\",\"RUN\",\"MANAGE_USERS_IN_ORG\"],\"userDisplayName\":\"{user}{userId}\"}]", 
		"LAST");
	...
	lr_end_transaction("UC_01_TR_03_add_new_member",2);

	lr_start_transaction("UC_01_TR_04_logout");

	lr_end_transaction("UC_01_TR_04_logout",2);

	return 0;
}
# 5 "c:\\users\\raevs\\onedrive\\\344\356\352\363\354\345\355\362\373\\vugen\\scripts\\uc_01_add_new_member\\\\combined_UC_01_add_new_member.c" 2
...
# 6 "c:\\users\\raevs\\onedrive\\\344\356\352\363\354\345\355\362\373\\vugen\\scripts\\uc_01_add_new_member\\\\combined_UC_01_add_new_member.c" 2
